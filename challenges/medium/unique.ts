...
type IncludesType<
  ArrayToCheck extends Array<any>,
  TypeToCheck extends any
> = ArrayToCheck extends [infer Head, ...infer Rest]
  ? Equal<Head, TypeToCheck> extends true
    ? true
    : IncludesType<Rest, TypeToCheck>
  : false;

type Unique<
  ArrayToFilter extends Array<any>,
  Result extends Array<any> = []
> = ArrayToFilter extends [infer Head, ...infer Rest]
  ? IncludesType<Result, Head> extends true
    ? Unique<Rest, Result>
