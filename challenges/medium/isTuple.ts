...
type IsTuple<PossibleTuple> = IsNever<PossibleTuple> extends true
  ? false
  : PossibleTuple extends Array<any>
  ? PossibleTuple["length"] extends Digit
    ? true
    : false
  : PossibleTuple extends ReadonlyArray<any>
  ? true
  : false;
