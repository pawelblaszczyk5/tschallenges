...
type DropHeadAndTail<Elements extends Array<any>> = Elements extends [
  any,
  ...infer MiddleElements,
  any
]
  ? MiddleElements
  : Elements;

type GetMiddleElement<Elements extends Array<any>> =
  Elements["length"] extends 0
    ? []
    : Elements["length"] extends 1
    ? [Elements[0]]
    : Elements["length"] extends 2
    ? [Elements[0], Elements[1]]
    : GetMiddleElement<DropHeadAndTail<Elements>>;
