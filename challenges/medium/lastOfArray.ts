...
type LastHacky<T extends any[]> = ["placeholder", ...T][T["length"]];

type Last<ArrayToExtractLastElement extends Array<any>> =
  ArrayToExtractLastElement extends [...infer _, infer Tail] ? Tail : never;
