...
type Reverse<
  ArrayToReverse extends Array<any>,
  Result extends Array<any> = []
> = ArrayToReverse extends [infer Head, ...infer Rest]
  ? Reverse<Rest, [Head, ...Result]>
  : Result;

type FlipArguments<FunctionToFlip extends (...rest: any) => any> = (
  ...rest: Reverse<Parameters<FunctionToFlip>>
) => ReturnType<FunctionToFlip>;
